...
Some of these buyers maybe arbitrageurs. When the issuance price finally goes up, IRMA sales will not be exclusively from issuance. Some of the early buyers (LPs) would now sell, earning more USDT. These LPs would then become buyers who can now use their USDT to buy back IRMA at a price slightly above the redemption price. The LPs end up having more IRMA in their hands.
