...
This is a set of Solana contracts started in solang (now continuing in Rust for easy integration with Anchor) that implement a flatcoin using a DEX (Meteora) and switching over to Rust to make it easy to integrate with Solana. This is now patent pending.
